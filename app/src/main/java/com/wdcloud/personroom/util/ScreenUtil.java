package com.wdcloud.personroom.util;
...
import com.wdcloud.personroom.app.MyApplication;
...
public class ScreenUtil {
    ...
    public static int getStatusBarHeight() {
        ...
        try {
            ...
            statusBarHeight = MyApplication.getInstance().getResources().getDimensionPixelSize(height);
        } catch (Exception e) {
            e.printStackTrace();
        }
